  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Nearby Stops</h1>
          <p className="text-gray-600">Find bus and train stops near your current location</p>
        </div>
            ...
            <Card>
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 mb-2">{stop.walkTime}</p>
              ...
              {mockStops.length === 0 && (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">No stops found in your area</p>
                  <p className="text-gray-400 text-sm">Try updating your location</p>
                </div>
              )}
            </Card>
          </div>
